...
class ModelTokenUsage:
    ...
    requests: int = 0
    completions: int = 0
    per_request_details: list = None  # Track per-API-call token breakdown
    
    def __post_init__(self):
        if self.per_request_details is None:
            self.per_request_details = []
    ...
    def update(
        ...
        if (
            ...
            reasoning_for_this_call = completion_usage.completion_tokens_details.reasoning_tokens
